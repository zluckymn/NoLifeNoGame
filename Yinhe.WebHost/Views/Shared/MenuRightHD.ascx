...
<% 
    ...
    if (SysAppConfig.IsPublish == false && AuthManage.UserType!= UserTypeEnum.DebugUser)
    {
        codeItems = new List<Item>()
        {
            ...
            new Item(){ id=2,name="PROJECTLIB_VIEW_PROJECT",value="",type="设计管理平台"},
        ...
        {
            //产品研发平台
            new Item(){ id=1,name="",value=",,,,,", type="项目资料库"},
            new Item(){ id=2,name="",value=",,,",type="标准化产品库"},
            new Item(){ id=3,name="" ,value="",type="市场产品信息库"},
            new Item(){ id=4,name="",value="",type="合作伙伴信息库"},
            new Item(){ id=5,name="",value="",type="建筑法律法规库"},
            new Item(){ id=6,name="",value="",type="各地建筑规范库"},
            new Item(){ id=7,name="",value="",type=""},
            new Item(){ id=8,name="",value="",type=""},
            new Item(){ id=9,name="",value=",,",type="系统设置"}
        };
    }
...
//       ArrMenuRight[5] = [true,true,true,true,true,true];
        ...
        //ArrMenuRight[2] = [true, true, true, true, true, true];
        //ArrMenuRight[3] = [true, true, true, true];
        //ArrMenuRight[5] = [true, true];
        //ArrMenuRight[10] = [true, true];
</script>
