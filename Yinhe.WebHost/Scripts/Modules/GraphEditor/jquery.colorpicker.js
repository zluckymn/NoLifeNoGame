...
(function($) {
    ...
    $.fn.colorpicker = function(options, pct) {
        ...
        function initColor(pct){
            var zIndex = 30000;
            if (pct && pct.isComp) zIndex = parseInt(pct.node.tag.style.zIndex, 10)||zIndex + 10;
            $("body").append('<div id="colorpanel" style="position: absolute; display: none;z-index:'+zIndex+'"></div>');
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
