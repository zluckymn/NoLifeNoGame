...
var _2f=$.data(_2e,"calendar").options,_now=new Date();
...
$(_ginpts.eq(0)).unbind("click").bind("click", function(){$(_a1c.el).val('').focus();});
$(_ginpts.eq(1)).unbind("click").bind("click", function(){_getNowD(_8);});
$(_ginpts.eq(2)).unbind("click").bind("click", function(){var _pp=$(_8).parent();if(_pp[0])_pp.hide();});
}
...
$.fn.calendar.defaults={width:180,height:180,fit:false,el:null,border:true,weeks:["S","M","T","W","T","F","S"],months:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(_3b){
}};
})(jQuery);
