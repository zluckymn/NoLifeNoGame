...
if(_48.selid && _50.id == _48.selid) _48.selnode = _51;
var _dstore={id:_50.id,text:_50.text,iconCls:_50.iconCls,attributes:_50.attributes};
if(_50.dtype) _dstore["dtype"]=_50.dtype;
if(_50.utype) _dstore["utype"]=_50.utype;
$.data(_51[0],"tree-node",_dstore);_dstore=null;
...
$.fn.tree=function(_b6,_b7,_b8){
if (typeof _b6 == "string") {
return $.fn.tree.methods[_b6](this,_b7,_b8);
}
var _b6=_b6||{};
...
},expandTo:function(jq,_ca,_fn){
return jq.each(function(){
_6f(this,_ca);
if($.isFunction(_fn)){_fn()}
});
...
$.fn.tree.defaults={url:null,method:"post",animate:true,selid:null,selnode:null,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,dnd:false,data:null,onBeforeLoad:function(_d3,_d4){
